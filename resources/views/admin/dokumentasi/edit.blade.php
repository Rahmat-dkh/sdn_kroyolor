...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="fw-bold">Edit Dokumentasi Siswa</h4>
    ...
    <div class="card-body p-4 p-md-5">
        <form action="{{ route('dokumentasi.update', $dokumentasi->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="judul" class="form-control form-control-lg bg-light border-0" value="{{ $dokumentasi->judul }}" required>
            </div>
            
            <div class="mb-4">
                <label class="form-label fw-bold">Deskripsi</label>
                <textarea name="deskripsi" class="form-control bg-light border-0" rows="4">{{ $dokumentasi->deskripsi }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                @if($dokumentasi->foto)
                    <div class="mb-2">
                        <img src="{{ asset('storage/'.$dokumentasi->foto) }}" class="rounded shadow-sm" style="width: 80px; height: 80px; object-fit: cover;">
                    </div>
                @endif
