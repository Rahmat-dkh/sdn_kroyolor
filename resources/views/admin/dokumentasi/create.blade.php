...
@section('title', 'Tambah Siswa - Admin SDN Kroyolor')
    ...
    <div class="card-body p-4 p-md-5">
        <form action="{{ route('dokumentasi.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="judul" class="form-control form-control-lg bg-light border-0" placeholder="Judul dokumentasi/foto peserta didik..." required>
            </div>
            
            <div class="mb-4">
                <label class="form-label fw-bold">Deskripsi</label>
                <textarea name="deskripsi" class="form-control bg-light border-0" rows="4" placeholder="Keterangan dokumentasi kegiatan..."></textarea>
            </div>
