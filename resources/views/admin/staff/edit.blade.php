...
<head>
    ...
    <title>Edit Staff - Admin SDN Kroyolor</title>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('staff.update', $staff->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @if($staff->foto)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/'.$staff->foto) }}" class="rounded-circle shadow-sm" style="width: 80px; height: 80px; object-fit: cover;">
                                </div>
                            @endif
