...
<div class="container-fluid">
    <div class="row">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar px-0">
            ...
            <a href="{{ route('peserta-didik.index') }}"><i class="bi bi-person-badge me-2"></i> Peserta Didik</a>
            <a href="{{ route('galeri.index') }}" class="active"><i class="bi bi-images me-2"></i> Galeri</a>
        </nav>
