...
<head>
    ...
    <title>Kelola Siswa - Admin SDN Kroyolor</title>
    ...
    <div class="row">
        ...
        <main class="col-md-10 main-content">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4>Kelola Peserta Didik</h4>
                <a href="{{ route('peserta-didik.create') }}" class="btn btn-primary"><i class="bi bi-plus-lg me-2"></i> Tambah Siswa</a>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end px-4">
                                        <div class="btn-group">
                                            <a href="{{ route('peserta-didik.edit', $item->id) }}" class="btn btn-sm btn-outline-info"><i class="bi bi-pencil"></i></a>
