                ...
                <div class="card-body p-4">
                    <form action="{{ route('peserta-didik.update', $pesertaDidik->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="judul" class="form-control" value="{{ $pesertaDidik->judul }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Deskripsi</label>
                            <textarea name="deskripsi" class="form-control" rows="4">{{ $pesertaDidik->deskripsi }}</textarea>
                        </div>
                        <div class="mb-3">
