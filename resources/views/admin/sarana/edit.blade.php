...
@section('title', 'Edit Sarana Prasarana - Admin SDN Kroyolor')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="fw-bold">Edit Sarana Prasarana</h4>
    ...
    <div class="card-body p-4 p-md-5">
        <form action="{{ route('sarana.update', $sarana->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama" class="form-control form-control-lg bg-light border-0" value="{{ $sarana->nama }}" required>
            </div>
            
            <div class="mb-4">
                <label class="form-label fw-bold">Deskripsi</label>
                <textarea name="deskripsi" class="form-control bg-light border-0" rows="4">{{ $sarana->deskripsi }}</textarea>
            </div>
            ...
            <div class="mb-4" id="input-foto">
                ...
                @if($sarana->foto)
                    <div class="mb-2">
                        <img src="{{ asset('storage/'.$sarana->foto) }}" class="rounded shadow-sm" style="height: 100px; object-fit: cover;">
                    </div>
                @endif
